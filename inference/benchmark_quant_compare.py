"""Benchmark Katie v6 across precisions — bf16 vs 8-bit vs 4-bit."""
import time
import os
import sys
...
for label, path in MODELS.items():
    ...
    mem_loaded = proc.memory_info().rss / 1024 / 1024
    ...
    print(f"  Load: {load_ms:.0f}ms | RAM: +{mem_loaded - mem_before:.0f}MB loaded, {mem_warm:.0f}MB after warmup")
    print()
    ...
    print(f"  RAM    — {mem_final:.0f}MB | Disk: {label}")
