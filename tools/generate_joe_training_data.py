"""Generate Joe training data via Qwen3-TTS 1.7B Base voice cloning (v1 recipe).

Same TEXTS list as v1 (generate_training_data.py) — 215 diverse English clips.
Reference: joe08h_subtle_nudge.wav (chosen voice design output for Joe).
Output: ~/Downloads/joe-training-data/ (matches shape of ivi-tts-training-data/).
"""
import time
import os
import json
...
# Transcript of the reference — this is the exact text joe08h speaks
REF_TEXT = (
    "Good morning. I've reviewed your schedule for today, and everything is in order. "
    "Your first meeting begins in forty-five minutes. Would you like me to prepare the car?"
)
...
# Same TEXTS list as v1 (generate_training_data.py)
TEXTS = [
